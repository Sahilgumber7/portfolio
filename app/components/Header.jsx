  ...
  return (
    <div className=' w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 '>
        ...
        <div className=' flex flex-col sm:flex-row items-center gap-4 mt-4 '>  
            <a className=" px-10 py-3 bg-black text-white border border-gray-500 rounded-full flex items-center gap-2 " href =" #contact "> Contact me <Image src= { assets.right_arrow_white } alt=" " className=" w-3 "  /></a>

            <a className=" px-10 py-3 border border-gray-500 rounded-full flex items-center gap-2 " href =" /sahilresumereal.pdf "> My Resume <Image src= { assets.download_icon } alt=" " className=" w-3 "  /></a>
